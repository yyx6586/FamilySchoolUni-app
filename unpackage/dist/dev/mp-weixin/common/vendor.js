...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"FamilySchoolUni-app","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/***/ 12:
/*!*******************************************************************!*\
  !*** /Users/zxl/Documents/yyx/FamilySchoolUni-app/store/index.js ***!
  \*******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _logger = _interopRequireDefault(__webpack_require__(/*! vuex/dist/logger */ 13));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}_vue.default.use(_vuex.default); // 修改日志

var modulesFiles = __webpack_require__(14); //第一个参数 -读取文件的路径，第二个参数 -是否遍历文件的子目录，第三个参数  -匹配文件的正则
console.log("modulesFiles", modulesFiles);
var modules = {};
modulesFiles.keys().reduce(function (module, modulePath) {

  if (!/\index.js$/.test(modulePath)) return;

  console.log("modulePath", modulePath);
  var moduleName = modulePath.replace(/^\.\/(.*)\/index\.\w+$/, '$1');
...
var debug = "development" !== "production"; // 开发环境中为true，否则为false
...
var store = new _vuex.default.Store({
  ...
  plugins: debug ? [(0, _logger.default)()] : [] // 开发环境下显示vuex的状态修改
});var _default =
